...
namespace IdentityManagment.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<IdentityManagment.Models.ApplicationUser> users;
        protected RadzenDataGrid<IdentityManagment.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(IdentityManagment.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(IdentityManagment.Models.ApplicationUser user)
        {
            try
            {
